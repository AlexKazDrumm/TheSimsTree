            ...
            <div className={styles.content}>
                ...
                <div className={styles.subtitleBlock}>
                    <span className={styles.subtitle}>
                        В связи с закрытием сайта PlumTreeApp мы сделали более современную и удобную версию для создания родословных наших любимых симов.
                    </span>
                    <span className={styles.subtitle}>
                ...
                <div className={styles.buttonBlock}>
                    <RegularButton type={'grey'} text={'Обратная связь'} event={() => {setSupportModalVisible(true)}} width={'250px'} height={'38px'} textSize={'16px'}/>
                </div>
            </div>
        </div>
    );
